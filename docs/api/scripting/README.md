...
| direction | `"up"` or `"down"` | `"down"` | Which way the timer should count. |
| type | `"time"`, `"currency"` or `"percent"` | `"time"` | Should the timer value show up as a time, currency or percentage. |
